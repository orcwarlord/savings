                ...
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div class="overflow-x-auto">
                            {{-- Form to create an organisation using route organisation store. name url and description fields --}}
                            <form method="POST" action="{{ route('organisation.store') }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="url" id="url" name="url" class="w-full border rounded p-2" required>
                                </div>
                                ...
                                <div class="text-right">
                                    <button type="submit" class="bg-blue-600 text-white rounded px-4 py-2 hover:bg-blue-800">Save</button>
                                </div>
                            </form>
